 ...
 *                double ts
 *                const double arr_len_in_data[]
 *                const int arr_len_in_size[2]
 *                double *dst
 *                double *vel
 * Return Type  : void
 */
void sliding_intergate_f(double data_in, double ts, const double
  arr_len_in_data[], const int arr_len_in_size[2], double *dst, double *vel)
{
  int idx;
  int i;
  boolean_T exitg1;
  ...
  double p[3];
  double dv6[512];
  (void)arr_len_in_data;
  (void)arr_len_in_size;
...
/*
 * File trailer for sliding_intergate_f.c
 *
 * [EOF]
 */
